...
const skillset = [
    { icon: 'vuedotjs', color: '#4FC08D', title: 'Vue.js', desc: 'The Progressive JavaScript Framework - An approachable, performant and versatile framework for building web user interfaces.', url: 'https://vuejs.org/', items: [
    ...
    { icon: '/images/Microsoft_Azure.svg', color: '#38c1f0', title: 'Azure', desc: 'Azure is a trusted cloud platform for building, deploying, and managing innovative solutions.', url: 'https://azure.microsoft.com/en-us', items: [
